...
- Create Angular project with ng: `ng new angulardoodle.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angulardoodle.client.esproj`).
